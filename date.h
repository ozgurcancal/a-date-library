...
public:
	...
	WeekDay get_week_day()const; //13	Haftanın gününü döndürüyor.
	...
	int month_to_date(int)const;	//yılın gününü hesaplayan üye fonksiyon
	...
	static constexpr bool isleap(int y); //26	Artık yıl testi yapan sınıfın static üye işlevi.
...
std::ostream& operator<<(std::ostream& os, const Date& date); //31		Date nesnelerinin değerlerini çıkış akımlarına yazdıracak global operatör işlevi (inserter) Formatlama şu şekilde: 31 Ekim 2019 Persembe
